	...
	<div class="title-wrapper">
		<div class="title-bg">
			<div class="title-content">
				<div class="two-third">
					<h2>Konfirmasi Permohonan Pinjaman</h2>
				</div>
...
<div class="centered-wrapper">
	<div class="percent-two-third">
		...
		?>
		<div id="loanform">
			<form method="post" action="<?=base_url()?>loan/loan_confirmation_action" name="loanform" id="loanform" enctype="multipart/form-data">
