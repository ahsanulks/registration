	<footer id="footer">
			...
			<div id="topfooter">
				...
				<div class="one-half column-last">
					...
					<div class="percent-one-half column-last">
						<h3>Koperasi Ini Itu</h3>
						<ul>
							<li>Jalan Kramat Raya No. 162<br>Jakarta Pusat 10430</li>
							<li>Ponsel: +6281 123 456 7<br/>
							E-mail: <a href="mailto:">email@koperasi.com</a></li>
						</ul>
					</div><!--end one-half-->					
				</div><!--end one-half-->
			</div><!--end topfooter-->
		...
		<div id="bottomfooter">		
			<div class="centered-wrapper">		
				<div class="one-half">
					<p>Copyright &copy; 2018 - evanworkspace | Hak Cipta Dilindungi</p>
				</div><!--end one-half-->
